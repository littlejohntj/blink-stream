...
// ): boolean {
// 		// you will need to fill in the input with the public key if not included
// 	// originally (since you wouldn't know it in advance) before verifying
...
//     // const connectToTiplink = useCallback(() => {
//     //   select(GoogleViaTipLinkWalletName)
//     //   connect().then(() =>{
//     //     // do connected stuff in here
//     //   }).catch((e) => {
//     //       console.error('its a me, error', e);
//     //   });
//     // }, [select, connect])
...
//             {/* <button
//                 onClick={connectToTiplink}
//                 className="flex items-center justify-center gap-1.5 h-11 w-[310px] px-3 py-2 bg-[#17303E] rounded-lg"
//                 style={{ position: 'fixed', bottom: '20px', left: '50%', transform: 'translateX(-50%)' }}
//             >
//                 <img
//                 src="/google.png" // Correct path pointing to the image in the public folder
//                 alt="Google"
//                     className="w-6 h-6"
//                 />
